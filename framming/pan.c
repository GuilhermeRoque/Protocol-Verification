...
short src_ln1 [] = {
	  0,  30,  31,  33,  34,  35,  36,  36, 
	 37,  38,  39,  40,  41,  32,  44,  32, 
	 46,  47,  48,  49,  51,  52,  53,  54, 
	 55,  56,  57,  50,  59,  59,  60,  61, 
	 62,  64,  65,  66,  67,  68,  69,  70, 
	 63,  72,  45,  74,  45,  76,  77,  78, 
...
short src_ln0 [] = {
	  0,   8,   9,  12,  13,  14,  15,  16, 
	 17,  18,  19,  11,  22,  11,  22,   0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "framming.pml", 1, 14 },
	{ "-", 15, 16 }
...
{	int j = 0, h = now._nr_pr;
	...
	case 1:	/* fram_Rx */
		...
		((P1 *)pptr(h))->frame = 0;
		((P1 *)pptr(h))->_nbytes = 0;
		((P1 *)pptr(h))->_max_bytes = 1024;
#ifdef VAR_RANGES
		logval("fram_Rx:frame", ((P1 *)pptr(h))->frame);
		logval("fram_Rx:nbytes", ((P1 *)pptr(h))->_nbytes);
		logval("fram_Rx:max_bytes", ((P1 *)pptr(h))->_max_bytes);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* fram_Tx */
		...
		((P0 *)pptr(h))->_nbytes = 0;
#ifdef VAR_RANGES
		logval("fram_Tx:nbytes", ((P0 *)pptr(h))->_nbytes);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{	/* int i; */
	...
	printf("	bit    frame:	%d\n", ((P1 *)pptr(pid))->frame);
	printf("	int    nbytes:	%d\n", ((P1 *)pptr(pid))->_nbytes);
	printf("	int    max_bytes:	%d\n", ((P1 *)pptr(pid))->_max_bytes);
		break;
	case 0:
