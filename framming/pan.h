...
#define _nstates1	62	/* fram_Rx */
#define minseq1	14
#define maxseq1	74
#define _endstate1	61

#define _nstates0	15	/* fram_Tx */
#define minseq0	0
#define maxseq0	13
...
#define Air1	(sizeof(P1) - Offsetof(P1, _max_bytes) - 1*sizeof(int))
...
#define Air0	(sizeof(P0) - Offsetof(P0, _nbytes) - 1*sizeof(int))
