...
#define _nstates2	12	/* check_err */
#define minseq2	94
#define maxseq2	104
#define _endstate2	11

#define _nstates1	4	/* inicia */
#define minseq1	87
#define maxseq1	89
#define _endstate1	3

#define _nstates0	92	/* arq_fsm */
#define minseq0	0
#define maxseq0	86
#define _endstate0	87
...
#define Pinicia	((P1 *)_this)
typedef struct P1 { /* inicia */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Parq_fsm	((P0 *)_this)
typedef struct P0 { /* arq_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 8; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, retry_counter) - 1*sizeof(int))
