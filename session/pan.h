...
#define _nstates3	14	/* verifica2 */
#define minseq3	146
#define maxseq3	158
#define _endstate3	13

#define _nstates2	14	/* verifica */
#define minseq2	133
#define maxseq2	145
...
#define _nstates0	131	/* session */
#define minseq0	0
#define maxseq0	129
#define _endstate0	130
...
#define Psession	((P0 *)_this)
typedef struct P0 { /* session */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 9; /* state    */
#ifdef HAS_PRIORITY
...
#define Air0	(sizeof(P0) - Offsetof(P0, rx) - 1*sizeof(uchar))
